...
public:
    ...
    bool clustering() {
        ...
        ErrorAssert(node != nullptr, LOG_TAG_VectorIndex, "Node should not be nullptr for node_id: " VECTORID_LOG_FMT, VECTORID_LOG(node_id));
        ...
        ErrorAssert(_root_id.Is_Valid(), LOG_TAG_VectorIndex, "Root ID should"
