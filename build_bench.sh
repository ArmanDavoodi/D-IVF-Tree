...
VAR_LOG_TAG_COMM_LAYER=ON
VAR_LOG_TAG_COMM_LAYER_NUM=$(( 2#100000000000 ))
VAR_LOG_TAG_HANG_DETECTOR=ON
VAR_LOG_TAG_HANG_DETECTOR_NUM=$(( 2#1000000000000 ))
VAR_LOG_TAG_NOT_IMPLEMENTED=ON
VAR_LOG_TAG_NOT_IMPLEMENTED_NUM=$(( 2#10000000000000 ))
VAR_LOG_TAG_TEST=ON
VAR_LOG_TAG_TEST_NUM=$(( 2#100000000000000 ))
...
if [ $VAR_LOG_TAG_COMM_LAYER == ON ]; then
    VAR_LOG_TAG=$(( VAR_LOG_TAG | VAR_LOG_TAG_COMM_LAYER_NUM ))
fi
